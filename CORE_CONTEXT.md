...
- **Action Pattern (Data):** When you need real-time prices while generating a portfolio report during the day, read from Mobile Bot's Shared Data Layer (Port 18791) or your websocket adapter (Port 18790).
